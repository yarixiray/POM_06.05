...
import PageFactory.LearningPage;
...
public class FindCoaches extends BaseTest{
    ...
    @Test
    public void checkThatLearningPage() throws Exception {
        LearningPage course1 = new LearningPage(driver);
        course1.pressButtonLearning();
        course1.chooseNecessaryCourse();
        course1.checkNameAndTeacher();
        course1.submitYourApplication();
        course1.checkFiledsOnApplication();
